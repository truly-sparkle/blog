...
const primaryColor = 'linear-gradient(#e66465, #9198e5);'
    ...
    return (
        <>
            ...
            <AppContainer className="App">
                ...
                <div className="board" style={{width: '80%',margin: '0 5%', display: 'flex', flexDirection: 'column', justifyContent:'flex-start', alignItems: 'center'}}>
